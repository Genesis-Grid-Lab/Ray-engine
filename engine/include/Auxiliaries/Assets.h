...
namespace RE {
    ...
    struct AssetRegistry {
        ...
        inline auto AddSkybox(AssetID uid, const std::string& source)
        {
            ...
            SetShaderValue(asset->Data.materials[0].shader, GetShaderLocation(asset->Data.materials[0].shader, "environmentMap"), (int[1]) MATERIAL_MAP_CUBEMAP, SHADER_UNIFORM_INT);
            SetShaderValue(asset->Data.materials[0].shader, GetShaderLocation(asset->Data.materials[0].shader, "doGamma"),  (int[1]) (useHDR ? 1 : 0) , SHADER_UNIFORM_INT);
            SetShaderValue(asset->Data.materials[0].shader, GetShaderLocation(asset->Data.materials[0].shader, "vflipped"), (int[1]) (useHDR ? 1 : 0) , SHADER_UNIFORM_INT);
